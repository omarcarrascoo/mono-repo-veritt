...
import { ScrollView, Text, TextInput, View, ActivityIndicator, Linking, TouchableOpacity } from 'react-native';
...
export default function ExploreScreen() {
  ...
  return (
    ...
    >
      <View className="w-full px-6 pt-24 md:items-center">
        <View className="w-full md:max-w-3xl">
